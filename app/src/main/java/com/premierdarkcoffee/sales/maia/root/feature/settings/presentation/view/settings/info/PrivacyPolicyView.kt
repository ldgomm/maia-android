...
fun PrivacyPolicyView(modifier: Modifier = Modifier) {
    Scaffold(topBar = {
        ...
        LazyColumn(modifier = modifier
            ...
            item {
                SettingsSectionView(title = "2. Information We Collect",
                                    content = "We collect the following types of information to provide and improve our services:")
                BulletPointList(bulletPoints = listOf("Store Information: When you manage your store through the application, we collect details such as store name, location, contact information, and operating hours.",
            ...
            item {
                SettingsSectionView(title = "3. Authentication",
                                    content = "Authentication for the Store Application is handled securely through:")
                BulletPointList(bulletPoints = listOf("Apple Sign-In (iOS): Administrators and store owners authenticate using their Apple credentials. No login information is stored by the app itself.",
            ...
            item {
                SettingsSectionView(title = "4. How We Use Your Information",
                                    content = "We use your store and product information to:")
                BulletPointList(bulletPoints = listOf("Provide access to the app's features for managing your store and products.",
            ...
            item {
                SettingsSectionView(title = "5. Sharing of Your Information",
                                    content = "We do not sell or share your store information with third parties, except in the following cases:")
                BulletPointList(bulletPoints = listOf("Legal Requirements: If required by law, we may disclose your information to comply with legal obligations.",
            ...
            item {
                SettingsSectionView(title = "8. Your Privacy Rights",
                                    content = "As a store owner, you have the following rights:")
                BulletPointList(bulletPoints = listOf("Access: You can request access to the data we have collected about your store and products.",
            ...
            // Contact Information
            item {
                Text(text = "If you have any questions or need assistance, please contact us at privacy@premierdarkcoffee.com.",
                     color = Color.Blue,
            ...
            // Footer
            item {
                Text(text = "© 2024 Maia, Premier Dark Coffee. All Rights Reserved.",
