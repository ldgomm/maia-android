        ...
        LazyColumn(modifier = modifier
            ...
            item {
                SettingsSectionView(title = "3. Authentication",
                                    content = "Authentication to Maia is handled through third-party services:")
                BulletPointList(bulletPoints = listOf("Apple Sign-In (iOS): Users authenticate via their Apple credentials, ensuring secure access to the app without Maia storing login credentials.",
            ...
            item {
                SettingsSectionView(title = "4. Product Management and Updates",
            ...
            item {
                SettingsSectionView(title = "5. Image and Content Guidelines",
                                    content = "When uploading product images, stores must ensure that:")
                BulletPointList(bulletPoints = listOf("Images are 1024x1024 pixels in size.",
                                                      "No phone numbers, contact information, or other personal details are included outside of what the app provides."))
                Text(text = "Stores should update product information only when strictly necessary, as existing information is considered valid. Improper updates or inclusion of unauthorized details may result in penalties or content removal.")
            }

            // Section 6: Communication with Clients
            item {
                SettingsSectionView(title = "6. Communication with Clients",
                                    content = "When chatting with clients through the app, stores must:")
                BulletPointList(bulletPoints = listOf("Be polite and professional at all times.",
            ...
            // Footer
            item {
                Text(text = "© 2024 Premier Dark Coffee. All Rights Reserved.",
